    ...
    <div className="bg-gradient-to-br from-white via-gray-50 to-gray-100 text-gray-800 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="relative text-left mb-14">
          ...
          <h1 className="relative text-5xl font-extrabold bg-gray-400 bg-clip-text text-transparent drop-shadow-md animate-fade-in">
            {itemList} {itemName}s
          </h1>
                ...
                >
                  <div className="overflow-hidden rounded-xl">
                    ...
                    <div className="p-5">
                      ...
                      <p className="text-gray-600 mt-2 text-sm">{product.details}</p>
